...
WELCOME_MESSAGE = '''\nWelcome to the financial calculator. Please see the calculations menu below:
...
if calculation == "investment":
    ...
    years = float(input("Please enter the amount of years you plan on investing: "))
    ...
    print(f"/nYou will earn {total_amount:.2f} on your investment.")


elif calculation == "bond":
    house_value = float(input("\nPlease enter the value of your house: "))
    interest_rate = float(input("Please enter the interest rate: "))
    months = float(input("Please enter how many months you plan to take to repay the bond: "))
    monthly_interest = interest_rate / 100 / 12
    repayment = (monthly_interest * house_value)/(1 - (1 + monthly_interest)**(-months))

    print(f"\nYou will need to repay {repayment:.2f} each month on your home loan.")
